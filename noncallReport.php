                              ...
                              <button  class="export-btn btn btn-primary">
                            	...
                            	<table class="table table-striped table-bordered table-condensed" id="table_row">
								  ...
								  <tbody>
									<?php
                                    if($role!=2){
										$sql="SELECT nonactivity.*,emp.emp FROM `nonactivity`,`emp` WHERE nonactivity.lead=emp.emp_id order by id DESC LIMIT 30" ;
										 ...
										 if (isset($_POST['search']))
										   {
                                                   ...
                                                   $sql="SELECT nonactivity.*,emp.emp FROM `nonactivity`,`emp` WHERE nonactivity.`date` BETWEEN '$checkdate' and '$todate' and nonactivity.lead=emp.emp_id order by id DESC " ;
                                                   $res=mysqli_query($conn,$sql);
											}
